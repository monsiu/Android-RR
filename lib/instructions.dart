    ...
    return Scaffold(
      ...
      body: ListView(children: <Widget>[
        ...
        Container(
          ...
          child: Text(
            'Android being an operating system made by Google is open source. This means its (source) code is available to the public to use and modify. This is commonly known as the Android Open Source Project (AOSP). The source code is modified by the public and this lead to the creation of custom ROMS, which are operating systems made by people outside of Google. The Custom ROMs are often Android in its purest form (vanilla) while others simply port operating systems from one phone to another, often for phones with a manufacturer skin on them that changes the look of Android like Samsung. Some ROMS offer Google Apps(gapps) while vanilla ROMS do not and they come with and are instead replaced with open source dialer app, camera app, messaging app and etc with no google apps or play store.',
            style: TextStyle(
              fontSize: 18,
              fontWeight: FontWeight.w200,
            ),
        ...
        Container(
          ...
          child: Text(
            'Every Phone has a recovery and this is where you find settings such as rebooting, factory reset, erase cache and other system settings. The recovery mode is often found when you turn off your phone and hold some buttons on your device and the phone boots into recovery...these buttons are specific to device and manufacturer so its best to read on how to do that on your device. The custom recoveries basically replace this stock (original) recovery with an advanced one with menus and more that you can use to install Custom ROMS by flashing the ZIP files which is something you can not do on stock recovery, hence having a Custom Recovery is ESSENTIAL AND A MUST!',
        ...
        Container(
            ...
            child: Text(
              'In your system Flash tool you may see a recovery section which you can place your custom recovery file to flash as the phones new recovery and the phone will boot into the new recovery you flashed. Odin (Samsung flash tool) does this. Otherwise flash the recovery through the terminal by booting your phone into fastboot mode and connect it to your pc and running fastboot flash recovery <recovery file name>.img Then running <fastboot reboot> to restart device then you hold the device specific button combination to boot into recovery. And thats it!',
              style: TextStyle(fontSize: 18, fontWeight: FontWeight.w200),
              textAlign: TextAlign.center,
            )),
        Container(
        ...
        Container(
            ...
            child: Text(
              'Once in the Custom recovery page. You need to take the custom rom zip file and move it into your phone download page and in the recovery page you choose install and you navigate to where you saved the file and you pick the custom ROM zip file and you swipe to flash it and upon completion click the wipe cache and then click reboot.',
              style: TextStyle(fontSize: 18, fontWeight: FontWeight.w200),
              textAlign: TextAlign.center,
            )),
        Container(
        ...
        Container(
            ...
            child: Text(
              'Google apps are not installed natively in custom roms (unless specified) so you may need to flash a zip file of the Google Apps called Gapps to get the Google Play Store as well as some Google Apps that are specified in the Gapps package you chose...but note there are alternative app stores that you can use to get your favourite apps. A good example is the Aurora Store that allows install without a Google Account and you can spoof your device to get device specific apps. There is also MicroG which works as a gapps alternative for when you need a google functionality in a bite sized format that is not systemwide like flashing gapps.',
              style: TextStyle(fontSize: 18, fontWeight: FontWeight.w200),
              textAlign: TextAlign.center,
            )),
        Container(
        ...
        Container(
            ...
            child: Text(
              'Magisk is our modern day rooter. It allows us to get root access systemlessly unlike the traditional and old root methods that actively changed the system partition in our device. Magisk gives us root and it installs to give us a wide range of features but please note that install of magisk may lead to device being detected as having root and banking apps may not work and Netflix will be hidden in the play store. There are workarounds in magisk to hide magisk from the troublesome apps so that is not much of an issue. Enable Denylist and add the troublesome apps to hide root from them and reopen them to see changes. Magisk also used to offer modules that you can flash within the app to get a wide range of features but that has been removed and so you can use Foxs Magisk Module Manager to find all these modules and you can also flash them in the Fox app too and they will also appear in your Magisk App as an installed module.',
              style: TextStyle(fontSize: 18, fontWeight: FontWeight.w200),
              textAlign: TextAlign.center,
            )),
        Container(
        ...
        Container(
            ...
            child: Text(
              'You have Installed A Custom Recovery And A Custom ROM with Gapps. That is all there is to do and you are set. The Magisk Root may cause problem in some Apps so its best to check the magisk settings and look for the Denylist and add the troublesome apps to hide root from them ',
              style: TextStyle(fontSize: 18, fontWeight: FontWeight.w200),
              textAlign: TextAlign.center,
            )),
      ]),
