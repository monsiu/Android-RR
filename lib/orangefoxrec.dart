      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            CachedNetworkImage(
              imageUrl:
"https://xiaomitools.com/wp-content/uploads/2020/04/of_forums_header_v2_hed_2-1024x432.jpg",              errorWidget: (context, url, error) => Icon(Icons.error),
            ),
            Center(
                child: Padding(
            ...
            Center(
                child: Text(
'OrangeFox Recovery is one of the most popular custom recoveries, with amazing additional features, fixes and a host of supported devices.',              style: TextStyle(fontSize: 18, fontWeight: FontWeight.w200),
              textAlign: TextAlign.center,
            )),
            Center(
                child: Padding(
