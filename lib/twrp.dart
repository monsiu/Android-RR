    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            CachedNetworkImage(
        imageUrl: "https://i0.wp.com/www.androidsage.com/wp-content/uploads/2021/01/TWRP-recovery.jpg",
        ...
        errorWidget: (context, url, error) => Icon(Icons.error),
            ...
            Center(
                child: Text(
'Team Win Recovery Project, pronounced "twerp", is an open-source software custom recovery image for Android-based devices. It provides a touchscreen-enabled interface that allows users to install third-party firmware and back up the current system which are functions often unsupported by stock recovery images.',              textAlign: TextAlign.center,
            )),
                Center(
                child: Padding(
              padding: const EdgeInsets.only(top: 60.0),
              child: Text(
'Features',                style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold),
                textAlign: TextAlign.center,
              ),
            )),
            Center(
